...
```
### Chaining details
#### succeeds -> [Mimikatz execution on compromised endpoint](mimikatz-execution-on-compromised-endpoint.md) (`7351e2ca-e198-427c-9cfa-202df36f6e2a`) (`sequence::succeeds`)
