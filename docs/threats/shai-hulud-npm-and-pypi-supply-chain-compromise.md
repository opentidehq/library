...
> **Development::Package Management::PyPI**
...
| --- | --- | --- | --- |
| Objective | [Detect Shai-Hulud npm and PyPI Supply Chain Compromise Activity](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md) (`fb62e879-9e91-4c5b-aaa7-999b2b1b3897`) | Downstream | objective |
| Signal | [Large Encoded Payload in Outbound HTTP from Developer or Build Hosts](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#large-encoded-payload-in-outbound-http-from-developer-or-build-hosts) (`21a527de-8635-4187-87d4-c9e5f5c1badc`) | Downstream | signal |
| Signal | [Unexpected GitHub Repository or Workflow Creation from Anomalous Context](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#unexpected-github-repository-or-workflow-creation-from-anomalous-context) (`287114bd-7d58-422d-9711-f5516900b9ce`) | Downstream | signal |
| Signal | [Developer Secret-File Access Followed by Outbound Network Egress](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#developer-secret-file-access-followed-by-outbound-network-egress) (`365e23e8-0367-4adf-b18a-f1440cc66005`) | Downstream | signal |
| Signal | [Known Shai-Hulud On-Disk and Network Indicator Match](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#known-shai-hulud-on-disk-and-network-indicator-match) (`678d0786-dfd7-40fb-ba90-3c368ed00342`) | Downstream | signal |
| Signal | [Anomalous npm Package Publish from Non-Baseline Host or Identity](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#anomalous-npm-package-publish-from-non-baseline-host-or-identity) (`9f3abdc4-7c6e-480e-b722-6d31ddd9b2d2`) | Downstream | signal |
| Signal | [Package Manager Install Spawning Unexpected Download or Scripting Child Processes](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#package-manager-install-spawning-unexpected-download-or-scripting-child-processes) (`a3f7d796-146c-44b0-8d22-7a08daa0d963`) | Downstream | signal |
| Signal | [Bulk Credential-Candidate File Access on Developer or CI Hosts](../Objectives/detect-shai-hulud-npm-and-pypi-supply-chain-compromise-activity.md#bulk-credential-candidate-file-access-on-developer-or-ci-hosts) (`b49d0a94-ae13-49b3-8ad8-6c035fa3d681`) | Downstream | signal |
